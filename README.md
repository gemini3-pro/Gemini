...
## 什么是 Gemini 中文版？
[**Gemini 中文版**](https://ai.lanjingchat.com) 是 Google 的 Gemini 模型的中文优化版本，专为中文用户设计，提供更流畅、更精准的 AI 对话体验。   
...
- [chat.yixiaai.com](https://xsimplechat.com/) - **Gemini 中文版**，支持 gemini-2.5-pro、claude-4.5-sonnet、GPT-5、o1、o3 及 Grok-4，支持 AI 绘画，扫码即可使用。
